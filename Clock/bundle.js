!function(){
  ...
  class t extends React.Component{
    ...
    warning(e){
      e < 61 ? this.setState({alarmColor: { color: "red"}}) : this.setState({alarmColor: {color: "white"}})
    }
    buzzer(e){
    ...
    clockify(){
      if(this.state.timer < 0)
        return "00:00";
      let e = Math.floor(this.state.timer / 60), t = this.state.timer - 60 * e;
      return t = t < 10 ? "0" + t : t,
        e = e < 10 ? "0" + e : e,
        e + ":" + t
    }
